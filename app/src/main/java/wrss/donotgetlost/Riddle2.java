...
public class Riddle2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        password1 = getString(R.string.kaczki_password1);
        password2 = getString(R.string.kaczki_password2);
        password3 = getString(R.string.kaczki_password3);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    toast.makeText(Riddle2.this, " zla opwiedź ",toast.LENGTH_SHORT).show();
                    answer.setText("");
                }
            }
        });
