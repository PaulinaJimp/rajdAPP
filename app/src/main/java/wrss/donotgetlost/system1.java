...
public class system1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        password1 = getString(R.string.system112);
        g.setCurrId(22);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (answer.getText().toString().trim().equalsIgnoreCase(password1) ){
                    ...
                    toast.makeText(system1.this, " zla opwiedź ", toast.LENGTH_SHORT).show();
                    answer.setText("");
                }
            }
        });
    ...
    public void openActvity2() {
        Intent intent = new Intent(this, koszulka.class);
